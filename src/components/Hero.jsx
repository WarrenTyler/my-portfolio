  ...
  return (
    <section className="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24">
      <div className="flex flex-wrap md:flex-nowrap">
        ...
        <img
          src="../src/images/portfolio-hero-lg.jpg"
          alt="A man staring at the sky in awe"
          className="mt-6 mx-auto md:w-full md:absolute md:right-0 md:mt-12 lg:mt-8 xl:mt-6 z-0"
        />
      </div>
    </section>
  );
